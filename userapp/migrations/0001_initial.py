    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooking_level', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('cuisines', models.ManyToManyField(default=None, related_name='cuisines', to='userapp.cuisinesmodel')),
                ('dietary', models.ManyToManyField(default=None, related_name='dietary', to='userapp.dietarymodel')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('author', 'follower'), name='followerUnique'),
        ),
        migrations.AddConstraint(
            model_name='followingmodel',
            constraint=models.UniqueConstraint(fields=('author', 'following'), name='followingUnique'),
        ),
    ]
